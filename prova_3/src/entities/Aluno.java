...
//
	public Aluno(String nome, String sexo, int idade, double nota1, double nota2, double nota3, double nota4, double mediaFinal, boolean aprovado) {
		this.nome = nome;
		this.sexo = sexo;
		this.idade = idade;
		this.nota1 = nota1;
...
//
	...
	public void presente(int presenca) {
		if(presenca == 1) {
